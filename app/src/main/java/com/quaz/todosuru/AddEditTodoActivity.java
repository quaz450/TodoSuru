...
public class AddEditTodoActivity extends AppCompatActivity {
    ...
    public static final String EXTRA_DESCRIPTION = "com.quaz.todosuru.EXTRA_DESCRIPTION";
    public static final String EXTRA_PRIORITY = "com.quaz.todosuru.EXTRA_PRIORITY";
